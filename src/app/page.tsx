  ...
  return (
    <>
      <section className="hero" aria-labelledby="hero-title">
        ...
        <MediaImage
          eager
          image={image("/images/hero/hero-tokyo-walk.webp", "東京の街を歩く人と商店街を表現したイメージ", 1600, 900)}
        />
      </section>
      ...
      <section className="section" aria-labelledby="courses-title">
        <div className="sectionHeader">
          ...
          <h2 id="courses-title">所要・距離・予算を比べる</h2>
        </div>
        <div className="cardGrid">{courses.map((route) => <RouteCard key={route.id} route={route} />)}</div>
      </section>
